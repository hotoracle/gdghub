...
<div class="row">
      ...
      <div class="span3 dashboardBox">
            <div class="bordered">
                  <div class="floatRight">
                        <?php echo $this->Html->link('Edit', 'editProfile', array('class' => 'btn btn-mini wideBtn bold')); ?>
                  </div>
            ...
            <div class="bordered">
                  <div class="floatRight">
                        <?php
                        if ($userSkillsets || $pendingSkillsets) echo $this->Html->link('Edit Skills', "editSkills", array('class' => 'btn btn-mini wideBtn bold'));
                        ?>
                  </div>
                  <h1>My Skills</h1>                
                  <?php
                  if ($userSkillsets || $pendingSkillsets) {
                        ?>
      ...
      <div class="span9 dashboardBox">
            <div class="bordered">
                  <div class="floatRight">
                        <?php
                        echo $this->Html->link('+ Add Project', "addProject", array('class' => 'btn btn-mini wideBtn bold'));
                        ?>
                  </div>
                  <h1>My Projects</h1>
                  <?php
