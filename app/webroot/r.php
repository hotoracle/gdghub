...
if (!defined('NOT_FOUND_IMAGE'))
      define('NOT_FOUND_IMAGE', 'img/gravatar_256.jpg');        // Image to serve if any 404 occurs 
if (!defined('ERROR_IMAGE'))
      define('ERROR_IMAGE', 'img/gravatar_256.jpg');         // Image to serve if an error occurs instead of showing error message 
