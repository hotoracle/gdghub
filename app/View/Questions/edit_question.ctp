...
/**
  Filename: edit_question.ctp 
  @author: Femi TAIWO [dftaiwo@gmail.com]
  Created: Mar 27, 2013  6:38:51 PM
 */
?>
<div>

      <h1>Edit Question</h1>
      <div class="floatRight"><?php echo $this->Html->link('My Questions', 'mine'); ?> | <?php echo $this->Html->link('View Question', "viewQuestion/$questionId/$questionSlug"); ?> </div>
      <p>
