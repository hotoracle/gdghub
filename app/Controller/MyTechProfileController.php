...
class MyTechProfileController extends AppController{
      ...
      public function index() {
            ...
            $this->set('userSkillsets', $userSkillsets);
      }
...
$technologies = array(
        ...
        if ($this->FormValidator->validate()) {
            ...
            $projectData = array(
                ...
                'project_url' => $submittedProjectData['website'],
    ...
    function viewProject($projectId = 0) {
        ...
        $this->set('projectPhotos', $this->ProjectPhoto->getProjectPhotos($projectId));
        if (!empty($this->data) && isset($this->data['ProjectPhoto']['upload'])) {
            $imagesSaved = 0;
...
//                $fileExtension = $fileParts[count($fileParts)-1];
    ...
    function editProject($projectId = 0) {
      ...
      public function deleteProjectPhoto($projectId,$photoId) {
                    $projectInfo = $this->_getUserProject($projectId);
